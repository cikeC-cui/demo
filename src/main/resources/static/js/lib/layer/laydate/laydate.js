...
;!function (a) {
    ...
    a.laydate = function (b) {
        ...
        /*add by wanghui 2017-08-04 解决日期控件边界溢出*/
        ...
        a.style.left=leftPX+(b?0:c.scroll(1))+"px", d = e.bottom + a.offsetHeight / 1.5 <= c.winarea() ? e.bottom - 1 : e.top > a.offsetHeight / 1.5 ? e.top - a.offsetHeight + 1 : c.winarea() - a.offsetHeight, a.style.top = d + (b ? 0 : c.scroll()) + "px"
    }, c.follow = function (a) {
